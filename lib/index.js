...
var food = new Food({width: cellSize, height: cellSize, color:'rgba(100, 25, 100, 100)'})
...
// adjust speed another way
   ...
   var nextPosition = head.nextPosition(directionRequest, cellSize);
...
document.addEventListener('keydown', function(e){
  ...
  keys[e.keyCode] ? directionRequest = keys[e.keyCode] :'';
